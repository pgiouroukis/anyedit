...
# MOM2 Samples Ablation Study - VERIFICATION RUN (20 samples)
# Saves to a SEPARATE folder to preserve original results
...
# NEW results directory for verification
RESULTS_DIR="/home/pg2860/anyedit/AnyEdit/output/mom2_ablation_results_20samples"
mkdir -p "$RESULTS_DIR"

echo "=========================================="
echo "MOM2 Ablation VERIFICATION (20 samples)"
...
echo ""
echo "=========================================="
echo "MOM2 Ablation Verification Complete!"
echo "=========================================="
echo ""
echo "Results saved to: $RESULTS_DIR"
echo "Original results preserved at: /home/pg2860/anyedit/AnyEdit/output/mom2_ablation_results"
echo ""
echo "Files:"
ls -la "$RESULTS_DIR"
